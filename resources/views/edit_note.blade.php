            ...
            <form action="{{ route('editNoteSubmit') }}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- Mensagem de erro titulo da nota --}}
                            @error('text_title')
                ...
                <div class="row mt-3">
                    <div class="col text-end">
                        ...
                        <button type="submit" class="btn btn-secondary px-5"><i class="fa-regular fa-circle-check me-2"></i>Atualizar nota</button>
                    </div>
                </div>
